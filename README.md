...
Here's a blank template to get started: To avoid retyping too much info. Do a search and replace with your text editor for the following: `sifterstudios`, `bitbucket-notifier`, `twitter_handle`, `linkedin_username`, `email_client`, `email`, `project_title`, `project_description`
...
2. Clone the repo
   ```sh
   git clone https://github.com/sifterstudios/bitbucket-notifier.git
   ```
...
See the [open issues](https://github.com/sifterstudios/bitbucket-notifier/issues) for a full list of proposed features (and known issues).
